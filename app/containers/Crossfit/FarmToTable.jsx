...
export const FarmToTable = () => {
  ...
  const extraContent = (
    <div className="font-barlow lg:text-left text-center lg:text-[18px] text-[14px] sm:font-medium font-normal mb-[30px] sm:leading-[26px] leading-[25px] tracking-[0px]">
      We believe in the transparency of our supply chain, from the pasture to
      your plate. This farm-to-table approach not only enhances the flavor and
      quality of our meats but also aligns with our values of honesty, health,
      and sustainability.
      <br />
      <br />
      ...
      <div className="flex-1">
        <div className="lg:w-[540px] lg:pt-[80px] lg:pb-0 pt-[45px] pb-[45px] lg:px-0 px-[20px] xl:pr-0 lg:pr-[20px] md:pr-[20px]">
          ...
          <div className="lg:block hidden font-barlow lg:text-left text-center lg:text-[18px] text-[14px] sm:font-medium font-normal mb-[30px] sm:leading-[26px] leading-[25px] tracking-[0px]">
            ...
            <br />
            <br />
            We believe in the transparency of our supply chain, from the pasture
            to your plate. This farm-to-table approach not only enhances the
            flavor and quality of our meats but also aligns with our values of
            honesty, health, and sustainability.
            <br />
            <br />
            ...
            <div className="font-barlow lg:text-left text-center text-[14px] font-bold tracking-[0px]">
              NEVER ANY:{' '}
              <span className="text-[#BF4745]">
                ARTIFICIAL COLORS, ARTIFICIAL FLAVORS, ANTIBIOTICS, HORMONES, OR
                SEED OILS.
              </span>
            </div>
          </div>
