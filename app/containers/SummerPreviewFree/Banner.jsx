...
import freeBadge from '~/assets/images/free-preview-badge.png'
    ...
    <section className="relative">
      <div className="lg:h-[calc(100vh-120px)] flex flex-col lg:pt-0">
        <div className="grid flex-1 grid-cols-1 lg:grid-cols-2">
          ...
          >
            <div className="relative lg:pt-0 pt-[20px]">
              ...
              <div className="font-hudson font-bold lg:text-[36px] text-[20px] lg:leading-[36px] leading-[20px] lg:tracking-[5.04px] tracking-[2.8px] text-center lg:mb-[12px] mb-[8px]">
                {sample.cost}
              </div>
              <div className="font-espiritu-condensed lg:text-[24px] lg:leading-[26px] lg:tracking-[0.48px] text-[18px] leading-[21px] tracking-[0.36px] text-center lg:mb-[20px] mb-[16px]">
                {sample.costDescription}
              </div>
              <div className="flex justify-center">
                <Button
                  loading={submitting}
              ...
              <img
                src={freeBadge}
                className="absolute right-[5px] lg:right-[16px] lg:bottom-[-60px] bottom-[-70px] lg:w-[94px] w-[51px]"
              />
            </div>
          </div>
        </div>
