...
export const FarmToTable = () => {
  ...
  const extraContent=<div className="font-barlow lg:text-left text-center lg:text-[18px] text-[14px] sm:font-medium font-normal mb-[30px] sm:leading-[26px] leading-[25px] tracking-[0px]">
                      We believe in the transparency of our supply chain, from the pasture to your plate. This farm-to-table approach not only enhances the flavor and quality of our meats but also aligns with our values of honesty, health, and sustainability.
                      <br />
                      <br />
                      It’s our great pride to offer a delicious, ethically- sourced product to our customers.
                      <br />
                      <br />
                      <div className="font-hudson lg:text-left text-center lg:text-[24px] text-[20px] font-[620] leading-normal tracking-[1.2px] uppercase ">GRASS FED & FINISHED</div><br />
    ...
    <section className="relative lg:h-[678px] flex flex-col-reverse lg:flex-row bg-[#F8F2E8] text-[#231B19]">
      ...
      <div className="flex-1">
        <div className="lg:w-[540px] lg:pt-[80px] lg:pb-0 pt-[45px] pb-[45px] lg:px-0 px-[20px] xl:pr-0 lg:pr-[20px] md:pr-[20px]">
          ...
          <div className="sm:hidden block text-center text-[#BF4745] text-[16px] font-bold leading-normal tracking-[0.8px] uppercase" onClick={()=>{setReadMore(!readMore)}}>{linkName}</div>
        </div>
      </div>
    </section>
  )
