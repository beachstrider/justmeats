...
export const DeliverToDoor = () => {
  return (
    <section>
      <div className="container sm:p-[50px] px-[20px] pb-[50px]">
        ...
        <div className="md:w-[700px] sm:flex sm:text-left text-center">
            ...
            <div>
                ...
                <div className="sm:text-[18px] text-[16px] pt-[20px]  font-medium sm:font-normal leading-[120%]">Once your order has been placed, and you’ve received your confirmation email, it will take 1-2 days to process your order.</div>
                <div className="sm:text-[18px] text-[16px] font-bold sm:font-medium leading-[120%]">*This is the point of no return. It’s super difficult to cancel or change your order once this happens*</div>
                <div className="sm:text-[18px] text-[16px] font-bold pt-[40px] pb-[20px] font-bold leading-[120%]">Weekly Shipping</div>
                <ul className="sm:text-[18px] text-[16px] list-disc pl-[30px] text-[#000] font-medium sm:font-normal leading-[120%]">
                    ...
                    <li>If your shipment arrives on a Saturday or Sunday, contact customer support asap at <span className="font-bold sm:font-normal">888-343-1242</span></li>
                </ul>
            </div>
        </div>
        <div className="md:w-[700px] sm:text-left text-center">
            <img className="sm:block hidden" src={justmeatBbox} alt="" />
            <div className="sm:text-[18px] text-[16px] font-bold pt-[40px] pb-[20px] font-bold leading-[120%]">In-Transit</div>
            <ul className="sm:text-[18px] text-[16px] list-disc pl-[30px] text-[#000] font-medium sm:font-normal leading-[120%]">
                ...
                <li>If your meat arrives warm, please send pictures and/or video to <span className="font-bold sm:font-normal underline sm:no-underline">support@justmeats.com</span></li>
            </ul>
        </div>
        </div>
      </div>
