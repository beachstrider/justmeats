            ...
            <div className="container sm:p-[50px] px-[20px] py-[50px]">
                <div className="md:w-[700px] sm:flex sm:text-left text-center">
                    ...
                    <div>
                        ...
                        <div className="sm:text-[62px] text-[54px] text-[#000] font-espiritu font-normal leading-[120%]">10 DAYS</div>
                        <div className="sm:text-[24px] text-[21px] text-[#7D0F21] font-bold leading-[120%] mt-[-20px] mb-[20px]">Stored in Fridge</div>
                        <div className="sm:text-[62px] text-[54px] text-[#000] font-espiritu font-normal leading-[120%]">90-120 DAYS</div>
                        <div className="sm:text-[24px] text-[21px] text-[#7D0F21] font-bold	leading-[120%] mt-[-20px] mb-[20px]">Frozen</div>
                        <div className="py-[20px]">
                            <DotsLine />
                        </div>
                        <div className="sm:text-[18px] text-[16px] text-[#000] font-medium sm:font-normal leading-[120%]">To thaw your meat, place it in the fridge overnight, and then reheat it using one of these three methods: </div>
