  ...
  return (
    <section className="relative z-[1] bg-[#EFEEED] text-[#231B19] py-[62px] sm:py-[103px]">
      <img
        ...
        className="absolute md:block hidden right-0 top-[8%]"
      />
      <div className="container flex flex-col items-center sm:mb-[56px] mb-[41px] relative">
        ...
        <div className="w-full grid md:grid-cols-3 grid-cols-1 sm:gap-[20px] gap-[12px]">
          <div
            className="bg-white px-[40px] py-[50px]"
          ...
          >
            ...
            <div className="font-nunito sm:text-[18px] text-[14px] font-normal leading-[26px] pt-[20px] sm:pt-[30px] text-center">
              Get your first box free! That&apos;s 6lbs of meats...looks like
              meat&apos;s back on the menu baby!
            </div>
          </div>
          <div
            className="bg-white px-[40px] py-[50px]"
          ...
          >
            ...
            <div className="font-nunito sm:text-[18px] text-[14px] font-normal leading-[26px] pt-[20px] sm:pt-[30px] text-center">
              You&apos;ll get a shareable customer discount promo code to share
              with your community! Get a 15% Commission on any orders you
              generate with your discount code.
            </div>
          </div>
          <div
            className="bg-white px-[40px] py-[50px]"
