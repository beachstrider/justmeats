          ...
          >
            {sliderImages.map((slider, index) => (
              <SwiperSlide key={index}>
                <div className="sm:bg-[url('../assets/images/butterybros-banner.png')] bg-[url('../assets/images/butterybros-bannermob.png')] h-full bg-cover sm:bg-top">
        ...
        <div className="px-[10px] container-small w-full grid md:grid-cols-3 grid-cols-1 gap-[30px] font-barlow text-[#231B19] pb-[50px]">
          ...
          >
            ...
            <div className="flex justify-center">
              <NavLink
                ...
                prefetch="intent"
                to="https://forms.gle/UDTcUaw1jBN5RQpLA"
              >
          ...
          >
            ...
            <ul className="list-disc pl-[20px] sm:text-[18px] text-[16px] font-medium sm:leading-[20px] leading-[23px] sm:tracking-[1.8px] tracking-[1.6px] my-[20px]">
              ...
              <li className="md:pb-[12px]">
                {' '}
                <span className="font-bold">FREE</span> Cookout Entry/Meal
              </li>
              <li className="md:pb-[12px]">
                Choose from a premade or build your own box{' '}
              </li>
              <li className="md:pb-[12px]">
                Save <span className="font-bold">25%</span> off any subscription{' '}
              </li>
              <li className="md:pb-[12px]">
                Save an additional <span className="font-bold">$15</span> with
                code <span className="font-bold">FRONING</span>
              </li>
            </ul>
            <div className="flex justify-center">
              <NavLink
                ...
                prefetch="intent"
                to={`/discount/pancakes?redirect=/products/custom-bundle?cart={"items":[{"handle":"hawaiian-teriyaki-chicken","quantity":"1"},{"handle":"hawaiian-teriyaki-beef","quantity":"1"},{"handle":"pollo-asado","quantity":"1"},{"handle":"texas-rub-chicken-thigh","quantity":"1"},{"handle":"slow-cooked-pulled-pork","quantity":"1"},{"handle":"sweet-spicy-pork","quantity":"1"}],"selling_plan":"Delivery-every-15-Days"}`}
              >
                <button className="px-[40px] py-[12px] bg-[#BF4745] hover:bg-[#6B1626] text-[#EFEEED] tracking-[.9px] uppercase font-bold">
                  shop just meats
                </button>
          ...
          >
            ...
            <ul className="list-disc pl-[20px] sm:text-[18px] text-[16px] font-medium sm:leading-[20px] leading-[23px] sm:tracking-[1.8px] tracking-[1.6px] my-[20px]">
              <li className="md:pb-[12px]">
                $40 value for <span className="font-bold">ONLY $19</span>
              </li>
              <li className="md:pb-[12px]">Food, games, giveaways, and FUN</li>
              <li className="md:pb-[12px]">
                Just Meats and Pit Boss delivering a world class BBQ Experience.
              </li>
            </ul>
            <div className="flex justify-center">
              <button className="px-[40px] py-[12px] bg-[#BF4745] hover:bg-[#6B1626] text-[#EFEEED] tracking-[.9px] uppercase font-bold">
