          ...
          <div className="px-[10px] container-small w-full grid md:grid-cols-3 grid-cols-1 gap-[30px] font-barlow text-[#231B19] pb-[50px]">
              <div className="relative hover:cursor-pointer flex flex-col justify-between text-[#231B19] bg-[#FFF] p-[30px] md:my-[50px] md:mx-0 mx-[10px]" style={{ boxShadow: '0px 40px 45px -14px rgba(0, 0, 0, 0.15)' }}>
                  ...
                  <div className="flex justify-center">
                      <NavLink end prefetch="intent" to="https://forms.gle/UDTcUaw1jBN5RQpLA">
              ...
              <div className="relative border-4 border-[#BF4745] hover:cursor-pointer flex flex-col justify-between text-[#231B19] bg-[#FFF] md:p-[30px] p-[30px]" style={{ boxShadow: '0px 40px 45px -14px rgba(0, 0, 0, 0.15)' }}>
                  ...
                  <div className="flex justify-center">
                      <NavLink end prefetch="intent" to="https://justmeats.com/discount/pancakes?redirect=/products/custom-bundle?cart_items=[{%22handle%22:%22hawaiian-teriyaki-chicken%22,%22quantity%22:%221%22},{%22handle%22:%22hawaiian-teriyaki-beef%22,%22quantity%22:%221%22},{%22handle%22:%22pollo-asado%22,%22quantity%22:%221%22},{%22handle%22:%22texas-rub-chicken-thigh%22,%22quantity%22:%221%22},{%22handle%22:%22slow-cooked-pulled-pork%22,%22quantity%22:%221%22},{%22handle%22:%22sweet-spicy-pork%22,%22quantity%22:%221%22}]&selling_plan=Delivery-every-15-Days">
                          <button className="px-[40px] py-[12px] bg-[#BF4745] hover:bg-[#6B1626] text-[#EFEEED] tracking-[.9px] uppercase font-bold">
                          shop just meats
                          </button>
                      </NavLink>
