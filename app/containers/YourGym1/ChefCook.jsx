import ChefCooker from '~/assets/images/hourseimg.png'
  ...
  return (
    <section className="relative bg-[#efeeed] text-white">
      <div className="relative">
        ...
        <div className="relative grid lg:grid-cols-2 grid-cols-1 gap-[62px] sm:gap-0 bg-[#222222]">
          <div className="relative sm:px-0 px-[20px] bg-[#222222]">
            <div className="absolute sm:hidden block left-0 w-full bottom-0 "></div>
            <img
