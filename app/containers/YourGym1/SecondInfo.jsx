...
import bg_second_info_image_2 from '../../assets/images/your-gym-secondinfo2.png'
  ...
  <section className="bg-[#efeeed]">
    <div className="flex flex-col md:flex-row justify-center w-full">
      <div className="flex flex-col basis-1/2 justify-center items-center ">
        <img
          className="w-full h-full md:max-h-[612px] pr-[15px] md:pr-0"
          src={bg_second_info_image_1}
          alt=""
        />
      </div>
      <div className="flex  basis-1/2 justify-start items-center ">
        <div className="flex flex-col">
          <div className="w-[90%] md:w-[85%] xl:w-[75%] text-center md:text-left mx-auto">
            <h1 className="lg:text-[28px] xl:text-[36px] sm:text-[22px] text-[24px] font-bold tracking-[1px] text-[#231B19] sm:mb-[12px] mb-[7px] pt-5">
              THE PROBLEM
            </h1>
            <p className="text-[14px] leading-[23px] tracking-[3px] font-normal text-[#7A392D] sm:mb-[25px] mb-[14px]">
    ...
    <div className="flex flex-col md:flex-row-reverse justify-center w-full">
      <div className="flex flex-col basis-1/2 justify-center items-center ">
        <img
          className="w-full h-full md:max-h-[614px] pl-[15px] md:pl-0 object-cover"
          src={bg_second_info_image_2}
          alt=""
        />
      </div>
      <div className="flex  basis-1/2 justify-start items-center ">
