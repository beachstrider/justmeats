...
export function MobileMenuAside() {
  ...
  const isSpecialsPage = location.pathname === '/rich-froning' || location.pathname === '/gym' || location.pathname === '/all-recipes' || location.pathname === '/recipe' || location.pathname === '/how-it-works';
